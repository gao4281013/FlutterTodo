...
const double _kLeadingWidtj = kToolbarHeight;
...
class _CustomAppBarState extends State<CustomAppBar>{
  ...
  Widget build(BuildContext context) {
       ...
       final bool hasEndDrawer = scaffoldState?.hasDrawer ?? false;
       ...
       if(leading == null && widget.automaticallyImplyLeading){
         ...
         if(leading != null){
           leading = new ConstrainedBox(
               constraints: const BoxConstraints.tightFor(width: _kLeadingWidtj),
               child: leading,
           );
         }
